...
export function NumberInput(props: Props): JSX.Element {
	return (
		<NumberField defaultValue={1} minValue={1} {...props} aria-label="Number input">
